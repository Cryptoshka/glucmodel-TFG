...
<head>
	...
	<!-- From lib folder: -->
  		...
  		<!--<script src="lib/Bootstrap/bootstrap-3.3.5-dist/css/jquery.min.js"></script>-->
    ...
    <script type="text/javascript" src="js/expediente-paciente.js"></script>
